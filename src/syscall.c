...
#include "syscall.h"
#include "common.h"
extern int __sys_mmstats(struct krnl_t*, uint32_t, struct sc_regs*);
...
{
    printf("[DEBUG] Syscall %d called by PID %d, params: a1=%d, a2=%d, a3=%d\n", 
           nr, pid, regs->a1, regs->a2, regs->a3);
